  ...
  return (
    <div className="bg-turquesa text-blau-fort instrument-serif-regular flex md:flex-row flex-col space-around items-center py-9 md:py-0">
      ...
      <div className="md:w-1/2 flex flex-col pl-8 md:pl-0 mt-8 md:mt-0">
        ...
        <p className="poppins-regular text-base text-left mt-9 mr-20">
          Carretera de Cànoves a Sant Antoni de Vilamajor (Km 43,8) 08458 Sant
          Pere de Vilamajor.
        </p>
        <div className="poppins-regular text-base text-left mt-9 mr-20">
          “Inclou detalls addicionals: si hi ha aparcament disponible, transport
          públic proper o si es recomana arribar amb temps.”
        </div>
        <a
